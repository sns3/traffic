...
{
    static TypeId tid =
        TypeId("ns3::CbrApplication")
            .SetParent<Application>()
            .AddConstructor<CbrApplication>()
            .AddAttribute("PacketSize",
                          "The size of constant packets sent.",
                          UintegerValue(512),
...
// Application Methods
void
CbrApplication::StartApplication() // Called at time specified by Start
{
    NS_LOG_FUNCTION(this);
...
void
CbrApplication::StopApplication() // Called at time specified by Stop
{
    NS_LOG_FUNCTION(this);
...
uint32_t
CbrApplication::GetSent(void) const
{
    NS_LOG_FUNCTION(this);
    return m_totTxBytes;
}
...
CbrApplication::SendPacket()
{
    ...
    {
        NS_LOG_INFO("At time " << Simulator::Now().GetSeconds() << "s cbr application sent "
...
void
CbrApplication::ConnectionSucceeded(Ptr<Socket> socket)
{
...
void
CbrApplication::ConnectionFailed(Ptr<Socket> socket)
{
    NS_LOG_FUNCTION(this << socket);
}
